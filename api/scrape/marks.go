...
func setMarksSession(bow *browser.Browser, cac *cache.Cache, regno string) {
...
func ShowMarks(bow *browser.Browser, regno, password, baseuri string, cac *cache.Cache) *GetMarks {
	setMarksSession(bow, cac, regno)
