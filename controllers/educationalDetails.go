/*
Educational details controller
*/
...
type EducationalDetailsController struct {
	beego.Controller
}
...
// @router / [post]
func (o *EducationalDetailsController) Post() {
	...
	if regNo != "" && psswd != "" {
		resp := api.ShowEducationalDetails(regNo, psswd, baseuri)
		o.Data["json"] = resp
	}
	o.ServeJSON()
}
